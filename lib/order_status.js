/**
 * Sweetbook JavaScript SDK — Order 상태값 카탈로그
 *
...
const ORDER_STATUS_FROM_CODE = Object.freeze(
  Object.fromEntries(Object.entries(ORDER_STATUS_CODE).map(([k, v]) => [v, k])),
);

module.exports = { OrderStatus, ORDER_STATUS_CODE, ORDER_STATUS_FROM_CODE };
